...
public class ArrayBasedPD implements PhoneDirectory {
    ...
    public void saveData(String filename) {
        ...
        try {
            ...
            {
                printWriter.println(phoneDirectory[i].getName());
                printWriter.println(phoneDirectory[i].getNumber());
            }
            printWriter.close();
    ...
    public String search(String name) {
        ...
        int index = Arrays.binarySearch(phoneDirectory, 0, numberOfEntries, new PhoneDirectoryEntry(name, null));
        ...
        {
            //JOptionPane.showMessageDialog(null, phoneDirectory[index].getNumber());
            return name + "'s number is " + phoneDirectory[index].getNumber();
        }
    }
}
